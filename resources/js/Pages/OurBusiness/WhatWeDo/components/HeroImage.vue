<template>
    <div
        ...
        :style="{
            'backgroundImage': `url(${asset('assets/frontend/images/ourbusiness/our_business_what_we_do_hero_image.webp')})`
        }"
    >
        ...
        <container>
            <div class="text-white grid lg:grid-cols-2 gap-2 relative z-[1] items-end">
                <div>
                    ...
                    <div class="content max-w-2xl text-xs lg:text-base !text-white mt-6" v-html="content.our_business_banner?.content"></div>
                </div>
