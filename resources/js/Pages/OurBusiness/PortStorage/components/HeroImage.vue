<template>
    <div
        ...
        :style="{
            'backgroundImage': `url(${asset('assets/frontend/images/ourbusiness/our_business_port_storage_hero_image.webp')})`
        }"
    >
            ...
            <div class="text-white grid lg:grid-cols-2 gap-2 relative z-[1] items-end">
                <div>
                    <h1 class="text-2xl leading-6  lg:text-[52px] lg:leading-[60px] font-medium max-w-2xl" id="home_banner_title">
                        Petrochemical Raw Material Port Logistics and Storage Services
                    </h1>
                    <!-- <h2 class="max-w-2xl text-xs lg:text-base mt-6 text-neutral-4">
