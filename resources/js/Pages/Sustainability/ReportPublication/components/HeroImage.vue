<template>
    <div
        ...
        :style="{
            'backgroundImage': `url(${asset('assets/frontend/images/sustainability/sustainability_report_pub_hero_image.webp')})`
        }"
    >
            ...
            <div class="text-white grid lg:grid-cols-2 gap-2 relative z-[1] items-end">
                <div>
                    ...
                    <h2 class="max-w-md text-xs lg:text-base mt-6 text-neutral-4">
                        Gain insight into our sustainable initiatives and achievements as we transparently share our progress in creating a positive impact on the planet and society.
                    </h2>
                </div>
