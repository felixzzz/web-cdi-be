...
@section('content')
    <div class="w-[500px] space-y-6">
        ...
        <form method="POST" action="{{ route('admin.investor.reports.update', $data->ulid) }}" class="flex flex-col gap-4" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            >
                ...
                <option value="anual_report" {{ $data->type == 'anual_report' ? 'selected' : '' }}>Anual Report</option>
