...
@section('content')
    <x-layouts.search :route-add="route('admin.page-management.our-business-tabs.contents.create', ['id' => $businessId, 'ourBusinessTab' => $tabId])" :show-add="true" />
            ...
            document.querySelectorAll('.sortable').forEach(table => {
                new Sortable(table, {
                    ...
                    onEnd: function (evt) {
                        ...
                        fetch("{{ route('admin.page-management.our-business-tabs.contents.sort', ['id' => $businessId, 'ourBusinessTab' => $tabId]) }}", {
                            method: "POST",
                            headers: {
