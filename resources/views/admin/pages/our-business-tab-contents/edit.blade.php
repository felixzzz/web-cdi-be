...
@section('content')
    <div class="w-full space-y-6">
        ...
        <form method="POST" action="{{ route('admin.page-management.our-business-tabs.contents.update', ['id' => $businessId, 'ourBusinessTab' => $tabId, 'contentId' => $data->ulid]) }}" class="flex flex-col gap-4" enctype="multipart/form-data">
            @csrf
            @method("PUT")
