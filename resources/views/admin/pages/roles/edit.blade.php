...
@section('content')
    <div class="w-[500px] space-y-6">
        ...
        <form method="POST" action="{{ route('admin.roles.update', $data->ulid) }}">
            @csrf
            @method("PUT")
                            ...
                            @foreach ($group as $permission)
                                <div class="flex items-center">
                                    <input
                                        ...
                                        {{ in_array($permission, $data->permissions) ? 'checked' : '' }}
                                    >
            ...
            <!-- Submit Button -->
            <div class="mt-6">
                <x-portal::button type="submit" class="w-full">Update Role</x-portal::button>
            </div>
        </form>
    </div>
@endsection
