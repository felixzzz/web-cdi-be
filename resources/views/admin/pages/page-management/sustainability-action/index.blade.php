...
@section('content')
    <form x-data="{ tab_page: 'banner' }" class="flex flex-col gap-4" method="POST" action="{{ route('admin.page-management.sustainability-action.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            <div x-show="tab_page === 'banner'" class="flex gap-4">
                <div class="flex flex-col gap-4 w-full">
                    <!-- EN -->
                    @include('admin.pages.page-management.sustainability-action.components.banner')
                </div>
                ...
                <div class="flex flex-col gap-4 w-full">
                    <!-- ID -->
                    @include('admin.pages.page-management.sustainability-action.components.banner', ['lang' => 'id'])
                </div>
            </div>
        </div>
