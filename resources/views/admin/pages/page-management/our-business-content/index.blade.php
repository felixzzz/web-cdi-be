...
@section('content')
    <form x-data="{ tab_page: 'banner' }" class="flex flex-col gap-4" method="POST" action="{{ route('admin.page-management.our-business-content.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            <div x-show="tab_page === 'banner'" class="flex gap-4">
                <div class="flex flex-col gap-4 w-full">
                    <!-- EN -->
                    @include('admin.pages.page-management.our-business-content.components.banner')
                </div>
                ...
                <div class="flex flex-col gap-4 w-full">
                    <!-- ID -->
                    @include('admin.pages.page-management.our-business-content.components.banner', ['lang' => 'id'])
                </div>
            </div>
            ...
            <div x-show="tab_page === 'overview'" class="flex gap-4">
                <div class="flex flex-col gap-4 w-full">
                    <!-- EN -->
                    @include('admin.pages.page-management.our-business-content.components.overview')
                </div>
                <div class="max-lg:hidden">
                    <x-portal::separator orientation="vertical" />
                </div>
                <div class="flex flex-col gap-4 w-full">
                    <!-- ID -->
                    @include('admin.pages.page-management.our-business-content.components.overview', ['lang' => 'id'])
                </div>
            </div>
        </div>
