...
<input type="hidden" name="content_json_swiper_icon_existing[{{ $rand }}]" value="{{ $file }}">
<x-portal::form.input label="Number" placeholder="Number" name="content_json_swiper_number[{{ $rand }}]" type="number" :value="$number" />
<div class="flex max-lg:flex-col w-full gap-4">
    <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
        ...
        <x-portal::form.input label="Title" placeholder="Title" name="content_json_swiper_title_en[{{ $rand }}]" type="text" :value="$title_en" />
        <x-portal::form.group
            label="Content"
        ...
        >
            <div>
                ...
                <textarea name="content_json_swiper_description_en[{{ $rand }}]" id="quill_editor_content_json_swiper_description_en_{{ $rand }}_value" class="hidden">{!! $description_en !!}</textarea>
            </div>
        </x-portal::form.group>
    </div>
    ...
    <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
        ...
        <x-portal::form.input label="Title" placeholder="Title" name="content_json_swiper_title_id[{{ $rand }}]" type="text" :value="$title_id" />
        <x-portal::form.group
            label="Content"
        ...
        >
            <div>
                ...
                <textarea name="content_json_swiper_description_id[{{ $rand }}]" id="quill_editor_content_json_swiper_description_id_{{ $rand }}_value" class="hidden">{!! $description_id !!}</textarea>
            </div>
        </x-portal::form.group>
    </div>
</div>
