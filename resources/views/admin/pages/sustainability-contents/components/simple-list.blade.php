...
<div class="flex max-lg:flex-col w-full gap-4">
    <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
        ...
        <x-portal::form.input label="Title" placeholder="Title" name="content_json_simple_title_en[]" type="text" />
        <x-portal::form.group
            label="Content"
            description=""
        ...
        >
            <x-portal::textarea name="content_json_simple_description_en[]" />
    ...
    <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
        ...
        <x-portal::form.input label="Title" placeholder="Title" name="content_json_simple_title_id[]" type="text" />
        <x-portal::form.group
            label="Content"
            ...
            description-trailing=""
        >
            <x-portal::textarea name="content_json_simple_description_id[]" />
        </x-portal::form.group>
    </div>
</div>
