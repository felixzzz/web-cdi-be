...
@section('content')
    <div class="w-full space-y-6">
        ...
        <form method="POST" action="{{ route('admin.sustainability-contents.store', ['category' => $category]) }}" class="flex flex-col gap-4" enctype="multipart/form-data">
            @csrf
            ...
            >
                ...
                <option value="simple_text_information" {{ old('type') == 'simple_text_information' ? 'selected' : '' }}>Simple Text Information</option>
                <option value="file_information" {{ old('type') == 'file_information' ? 'selected' : '' }}>File Information</option>
                <option value="list_information" {{ old('type') == 'list_information' ? 'selected' : '' }}>List Information</option>
                <option value="swiper" {{ old('type') == 'swiper' ? 'selected' : '' }}>Swiper</option>
            </x-portal::form.select>
            ...
            <section class="flex flex-col gap-4" id="grid_type_section">
                <x-portal::form.select
                    ...
                    description-trailing=""
                >
                    <option value="icon_content_card" {{ old('grid_type') == 'icon_content_card' ? 'selected' : '' }}>Icon Content Card</option>
                    <option value="icon_list_card" {{ old('grid_type') == 'icon_list_card' ? 'selected' : '' }}>Icon List Card</option>
                    <option value="box_icon_card" {{ old('grid_type') == 'box_icon_card' ? 'selected' : '' }}>Box Icon Card</option>
                    <option value="image_content_card" {{ old('grid_type') == 'image_content_card' ? 'selected' : '' }}>Image Content Card</option>
                </x-portal::form.select>
            </section>
            ...
            <section class="flex flex-col gap-4" id="grid_direction_section">
                <x-portal::form.select
                    ...
                    description-trailing=""
                >
                    <option value="row" {{ old('grid_direction') == 'row' ? 'selected' : '' }}>Row</option>
                    <option value="col" {{ old('grid_direction') == 'col' ? 'selected' : '' }}>Column</option>
                </x-portal::form.select>
            </section>
            ...
            <section class="flex flex-col gap-4" id="grid_pattern_section">
                <x-portal::form.select
                    ...
                    description-trailing=""
                >
                    <option value="normal" {{ old('grid_pattern') == 'normal' ? 'selected' : '' }}>Normal</option>
                    <option value="zig-zag" {{ old('grid_pattern') == 'zig-zag' ? 'selected' : '' }}>Zig-Zag</option>
                </x-portal::form.select>
            </section>
            ...
            <x-portal::form.select
                ...
                description-trailing=""
            >
                <option value="normal" {{ old('background') == 'normal' ? 'selected' : '' }}>Normal</option>
                <option value="darkest" {{ old('background') == 'darkest' ? 'selected' : '' }}>Darkest</option>
            </x-portal::form.select>
