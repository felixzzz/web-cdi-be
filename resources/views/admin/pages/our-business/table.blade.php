                        ...
                        <x-portal::table.cell class="font-medium text-right">
                            <x-portal::dropdown-menu class="flex justify-end">
                                ...
                                <x-portal::dropdown-menu.content class="w-fit" align="end">
                                    <x-portal::dropdown-menu.item :href="route('admin.page-management.our-business-list.edit', $row->ulid)" as="a" >
                                        Edit
                                    </x-portal::dropdown-menu.item>
                                    <x-portal::dropdown-menu.item :href="route('admin.page-management.our-business-tabs.index', ['id' => $row->ulid ])" as="a" >
                                        Tabs
                                    </x-portal::dropdown-menu.item>
