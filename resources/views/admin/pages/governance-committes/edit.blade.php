...
@section('content')
<form method="POST" action="{{ route('admin.governance-committes.update', $data->ulid) }}" enctype="multipart/form-data" class="flex flex-col gap-4">
    @csrf
    @method("PUT")
    ...
    <x-portal::form.input label="File Name" placeholder="File Name" name="file_name" :value="$data->file_name" type="text" />

    <div class="flex gap-4 w-full" >
        <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
            <img src="{{ asset('assets/frontend/icons/flag_en.svg') }}" alt="" class="w-5">
            <x-portal::form.input label="Tab Title" placeholder="Tab Title" name="tab_title_en" :value="$data->tab_title_en" type="text" required />
        ...
        <div class="flex flex-col gap-4 w-full lg:max-w-[48%]">
            ...
            <x-portal::form.input label="Tab Title" placeholder="Tab Title" name="tab_title_id" :value="$data->tab_title_id" type="text" required />
